document.querySelector('.download-modpack').addEventListener('click', function() {
    window.open('https://drive.google.com/file/d/1B29cFHwAcgoE4jVY_zXfGuY2X33CY6GA/view?usp=sharing', '_blank');
});
